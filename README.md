...
~~~sh
# getting the code
git clone git@github.com:nko5/biohackers.git && cd ./biohackers/
...
# deploying to Modulus (to http://biohackers.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/biohackers" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
